...
public class Principal {
    ...
    public static int mostrarMenu() {
        ...
        System.out.println("13.Guardar en fichero binario.");
        System.out.println("14.Leer desde fichero binario.");
        System.out.println("15.Guardar en fichero de texto.");
        System.out.println("16.Leer desde fichero de texto.");
        ...
        do {
            ...
            switch (opt) {
                ...
                case 13:
                    ...
                    concesionario.guardarFicheroBinario();
                    break;
                    
                case 14:
                    System.out.println("Leyendo fichero binario...");
                    concesionario.leerFicheroBinario();
                    break;
                    
                case 15:
                    System.out.println("Guardando fichero .TXT...");
                    concesionario.guardarFicheroTexto();
                    break;
                    
                case 16:
                    System.out.println("Leyendo fichero .TXT...");
                    concesionario.leerFicheroTexto();
                    break;
