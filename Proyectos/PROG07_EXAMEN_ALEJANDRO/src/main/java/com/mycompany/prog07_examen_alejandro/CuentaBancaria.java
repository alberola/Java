 ...
 */
package com.mycompany.prog07_examen_alejandro;
...
public abstract class CuentaBancaria implements Imprimible, Comparable<CuentaBancaria> {
    ...
    public int hashCode() {
        int hash = 7;
        hash = 97 * hash + Objects.hashCode(this.ccc);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return !this.ccc.equalsIgnoreCase(other.ccc);
    }

    @Override
    public int compareTo(CuentaBancaria o) {
        return ccc.compareTo(o.ccc);
        }
}
