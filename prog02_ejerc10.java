...
public class prog02_ejerc10 {
    public static void main(String[] args){
        ...
        z = cx;//Cambiamos formato de variable y no es necesario insertar el int.
        System.out.printf("%d short-char-int = %d\n",sx,z);//Creo que hay un error en el planteamiento ya que no da, en todo caso para que me diera como se pide z = cx.
        sx = -1;
