...
public class PROG07_Tarea {
 ...
 /*DNI del titular*/
        ...
        while (!cuentaValida) {
            ...
            cuentaValida = true; //CuentaBancaria.validarCuenta(ccc);
            if (!cuentaValida) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Aqui cargaremos los datos desde el fichero binario.
        banco.cargarFicheroBinario();
        ...
        while (!fin) {
            ...
            System.out.println("[7] Guardar Cuentas en fichero binario.");
            System.out.println("[8] Leer cuentas desde fichero binario.");
            System.out.println("[9] Insertar cuentas ejemplo.");
            System.out.println("[10] Listado Cuentas (Cargar en fichero TXT).");
            System.out.println("[11] Listado Clientes (Cargar en fichero TXT).");
            ...
            switch (selec) {
                case 1: //Abrir nueva cuenta
                    if (banco.abrirCuenta(obtenDatos())) {
                        ...
                        System.out.println("Error al insertar la cuenta, ya existe");
                    }
                    break;
...
//                    }
                ...
                case 3: //Información de Cuenta.
                    ...
                    while (!cuentaValida) {
                        ...
                        ccc = Util_ES.lecturaTeclado();
                        cuentaValida = true;
                        //CuentaBancaria.validarCuenta(ccc);
                        if (!cuentaValida) {
                            System.err.println("Cuenta no válida.");
                        }
                    }
                ...
                case 7:
                    ...
                    banco.guardarFicheroBinario();
                    break;
                    
                case 8:
                    System.out.println("Leyendo fichero binario...");
                    banco.leerFicheroBinario();
                    break;
                
                case 9:
                    System.out.println("Insertando cuentas de ejemplo...");
                    banco.crearCuentasEjemplo();
                    break;
                
                case 10:
                    System.out.println("Guardando en fichero .TXT...");
                    banco.guardarFicheroSplit();
                    break;                   
                case 11:
                    System.out.println("Guardando en fichero .TXT...");
                    banco.guardarFicheroTexto();
                    System.out.println("-----------------------------");
                    System.out.println("Leyendo fichero de texto...");
                    System.out.println("-----------------------------");
                    banco.leerFicheroTexto();
                    break;
                    
                case 12:
                    System.out.println("¿ Desea guardar el listado de cuentas de clientes del apartado anterior ?");
