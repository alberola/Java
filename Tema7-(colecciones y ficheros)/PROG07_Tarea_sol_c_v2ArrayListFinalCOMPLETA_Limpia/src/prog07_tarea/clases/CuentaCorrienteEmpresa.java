...
public class CuentaCorrienteEmpresa extends CuentaCorriente{
    ...
    public void retirar (double cantidad) throws Exception {
        ...
        if (getSaldo() + maximoDescubierto >= cantidad) { // Si el saldo permite retirar esa cantidad
             double saldoAux = getSaldo();
            setSaldo(saldoAux-= cantidad);
              // Se retira esa cantidad (puede haber descubiertos si saldo<0)
        }
        else {
    ...
    public String toString() {
        return "CuentaCorrienteEmpresa{"+ devolverContenidoString() +"} \n";
    }
